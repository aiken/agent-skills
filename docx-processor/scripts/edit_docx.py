...
def edit_docx(input_path: Path, output_path: Path, replacements: dict, backup: bool = False):
...
def main():
    parser = argparse.ArgumentParser(description='Edit text in a .docx file')
    ...
    try:
        ...
        edit_docx(input_path, output_path, replacements, backup=args.backup)
